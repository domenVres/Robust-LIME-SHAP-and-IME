"""
Preparation for IME variance experiment on COMPAS. This code splits the data into training and evaluation set,
...
data_train.to_csv("..\Data\IME\compas_train.csv", index = False)
data_test.to_csv("..\Data\IME\compas_test.csv", index = False)
...
np.save("../Data/IME/Compas/bayes_values", real_values_bayes)
filename = "../Data/IME/Compas/bayes_model.sav"
...
# Save the classifier and shapley values
np.save("../Data/IME/Compas/svm_values", real_values_svm)
filename = "../Data/IME/Compas/svm_model.sav"
...
# Save the classifier and shapley values
np.save("../Data/IME/Compas/forest_values", real_values_forest)
filename = "../Data/IME/Compas/forest_model.sav"
...
# Save the classifier and shapley values
np.save("../Data/IME/Compas/nn_values", real_values_nn)
filename = "../Data/IME/Compas/nn_model.sav"
